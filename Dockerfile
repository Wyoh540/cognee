...
# /data is baked into the image cognee-owned so a fresh named
...
# accident rather than by design). docker-compose mounts a named volume here.
ENV SYSTEM_ROOT_DIRECTORY=/data/system
ENV DATA_ROOT_DIRECTORY=/data/uploads
ENV CACHE_ROOT_DIRECTORY=/data/cache
ENV COGNEE_LOGS_DIR=/data/logs
ENV FASTEMBED_CACHE_PATH=/data/models/fastembed
